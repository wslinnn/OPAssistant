...
<!-- TODO: 补充 3-4 帧 —— 首页仪表盘 / 插件编辑(WiFi 或防火墙)/ 快捷工具箱 / 运维工具中心 -->
...
**快捷工具箱** — 五个常用开关一键切换
WiFi 分频段 · IPv6 · 防火墙 · FullCone(IPv4 / IPv6)· UPnP;按设备能力探测可用性,高危项二次确认 + rollback 兜底
...
pages/device/apps/     运维工具(diag/syslog/conntrack/route/process/startup/reboot)+ toolbox 快捷工具箱
